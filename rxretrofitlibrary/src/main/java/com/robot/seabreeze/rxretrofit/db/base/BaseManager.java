package com.robot.seabreeze.rxretrofit.db.base;
...
import com.robot.seabreeze.rxretrofit.db.upgrade.UpgradeOpenHelper;
import com.robot.seabreeze.rxretrofit.db.interfaces.IDatabase;
import com.robot.seabreeze.rxretrofit.download.DaoMaster;
import com.robot.seabreeze.rxretrofit.download.DaoSession;
...
public abstract class BaseManager<M, K> implements IDatabase<M, K> {
    ...
    public static final String DEFAULT_DATABASE_NAME = "cookie_db";
    ...
    public static void initOpenHelper(@NonNull Context context) {
        ...
        UpgradeOpenHelper helper = new UpgradeOpenHelper(context, DEFAULT_DATABASE_NAME, null);
